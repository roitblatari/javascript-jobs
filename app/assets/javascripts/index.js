$(function () {
  ...
  employeeLoginForm();
  // $('a#employee-login').on("click", (e) => employerLoginForm(e))
  employerLoginForm();
  // $('a#employee-login').on("click", (e) => employerLoginForm())
  // employerNewForm() 
  employeeNewForm();
  ...
  $('#past-jobs-employee').on("click", (e) => pastJobsIndex(e))
...
const employeeLoginForm = () => {
  $('#employee-login').on("click", function (e) {
